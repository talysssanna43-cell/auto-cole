(function () {
    const PACKS = Object.freeze({
        'tarif-chill-5': { label: 'Chill boite manuelle - 5 cours', price: 249, courses: 5, transmission: 'BM' },
        'tarif-chill-10': { label: 'Chill boite manuelle - 10 cours', price: 499, courses: 10, transmission: 'BM' },
        'tarif-chill-20': { label: 'Chill boite manuelle - 20 cours', price: 649, courses: 20, transmission: 'BM' },
        'tarif-chill-30': { label: 'Chill boite manuelle - 30 cours', price: 1149, courses: 30, transmission: 'BM' },
        'tarif-premium-5': { label: 'Premium boite manuelle - 5 cours', price: 395, courses: 5, transmission: 'BM' },
        'tarif-premium-10': { label: 'Premium boite manuelle - 10 cours', price: 599, courses: 10, transmission: 'BM' },
        'tarif-premium-20': { label: 'Premium boite manuelle - 20 cours', price: 749, courses: 20, transmission: 'BM' },
        'tarif-premium-30': { label: 'Premium boite manuelle - 30 cours', price: 1249, courses: 30, transmission: 'BM' },
        'tarif-accelere-5': { label: 'Accelere boite manuelle - 5 cours', price: 499, courses: 5, transmission: 'BM' },
        ...
        '20h': { label: 'Chill boite manuelle - 20 cours', price: 649, courses: 20, transmission: 'BM' },
        chill: { label: 'Chill boite manuelle - 20 cours', price: 649, courses: 20, transmission: 'BM' },
        zen: { label: 'Chill boite manuelle - 20 cours', price: 649, courses: 20, transmission: 'BM' },
    ...
    const UPGRADE_PACK_IDS = [
        'tarif-chill-5', 'tarif-chill-10', 'tarif-chill-20', 'tarif-chill-30',
        'tarif-premium-5', 'tarif-premium-10', 'tarif-premium-20', 'tarif-premium-30',
        'tarif-accelere-5', 'tarif-accelere-10', 'tarif-accelere-20', 'tarif-accelere-30',
