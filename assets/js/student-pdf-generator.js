...
// Fonction pour envoyer le PDF par email à l'élève
window.sendStudentPDFByEmail = async function(studentEmail) {
    try {
        ...
        // Générer le PDF (même code que downloadStudentPDF mais sans télécharger)
        const { jsPDF } = window.jspdf;
        const doc = new jsPDF();
        
        // [Copier tout le code de génération du PDF ici - même logique que downloadStudentPDF]
        // Pour simplifier, on va appeler une fonction commune
